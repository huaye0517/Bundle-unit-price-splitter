...
$LauncherExe = Join-Path $LauncherBuildDir "BundleUnitPriceSplitter_v9.exe"
...
Copy-Item -LiteralPath $LauncherExe -Destination "outputs\BundleUnitPriceSplitter_v9.exe" -Force

Write-Host "Built outputs\BundleUnitPriceSplitter_v9.exe"
